...
class SharedWorkflowContractTests(unittest.TestCase):
    ...
    def test_uses_discovery_and_mirror_matrices(self) -> None:
        ...
        self.assertIn("optional-source-secret-list: ${{ steps.config_meta.outputs.optional-source-secret-list }}", text)
    ...
    def test_uses_config_specific_target_pat_secret(self) -> None:
        ...
        self.assertIn("discover-secret-list: ${{ steps.config_meta.outputs.discover-secret-list }}", text)
        self.assertIn("optional-source-secret-list=", text)
        ...
        self.assertIn("GL_GROUPS_SOURCE_USERNAME", text)
        self.assertIn("GL_GROUPS_SOURCE_TOKEN", text)
        ...
        self.assertIn("Fetch optional source Git credentials from BWS", text)
        self.assertIn("continue-on-error: true", text)
        self.assertIn("steps.fetch_optional_source_git_credentials.outcome == 'success'", text)
